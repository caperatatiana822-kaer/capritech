...
export default function TablaMastitis() {
  ...
  useEffect(function cargarMastitis() {
    async function obtenerMastitis() {
      try {
        setCargando(true)
        setError("")
        
        const respuesta = await fetch("http://localhost:3001/api/mastitis/mastitisAll")
